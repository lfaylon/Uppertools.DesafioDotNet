...
{
    public abstract class DesafioDotNetWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DesafioDotNetWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DesafioDotNetWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<DesafioDotNetDbContext> action)
        {
            using (var context = IocManager.Resolve<DesafioDotNetDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<DesafioDotNetDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<DesafioDotNetDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DesafioDotNetDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DesafioDotNetDbContext, Task<T>> func)
        {
            T result;
